      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        {challenges.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-slate-500 italic">Nenhum curso ou aula encontrado no momento.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            {/* Main Content Column */}
            <div className="lg:col-span-8 space-y-12">
              {/* Featured Course of the Day */}
              {challenges.length > 0 && (
                  ...
                  {(() => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`group relative bg-slate-50 border rounded-3xl overflow-hidden transition-all ${
                      ...
                      {otherChallenges.map((challenge, index) => {
                        ...
                        return (
                          <motion.div
                            ...
                            className={`group relative bg-slate-50 border rounded-3xl overflow-hidden transition-all cursor-pointer ${
                            ...
                            <div className="p-5">
                              <div className="flex items-center gap-2 mb-2">
                                <h3 className={`text-xl font-bold font-display ${
                                  completedItems.has(challenge.id) ? 'text-slate-500' : unlocked ? 'text-slate-900' : 'text-slate-400'
                                }`}>{challenge.title}</h3>
                                {completedItems.has(challenge.id) && (
                        ...
                        {groupDiaryByDay().map(([date, entries]) => (
                          ...
                          >
                            ...
                            <div className="space-y-3">
                              {entries.map((entry) => (
                                <div key={entry.id} className="p-4 rounded-2xl bg-slate-50 border border-slate-200 hover:bg-slate-100 transition-colors">
              ...
              {activeVideo.url && (
                <div className="p-6 bg-slate-50 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex flex-col gap-1 text-center sm:text-left">
                    ...
                    <h4 className="text-base font-bold text-slate-900 font-display">{activeVideo.title}</h4>
                  </div>
                  <a 
