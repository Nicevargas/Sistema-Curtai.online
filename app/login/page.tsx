    ...
    <main className="min-h-screen bg-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-slate-900 font-display mb-2 -mt-8">Bem-vinda de volta</h1>
          <p className="text-slate-600">Continue seu curso</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 text-slate-900 focus:outline-none focus:border-primary/50 transition-colors"
