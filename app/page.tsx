                ...
                <Link href="/lyra">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-xl font-bold text-slate-900 mb-2 font-display">Consultor Online</h3>
                      <p className="text-sm text-slate-600 leading-relaxed mb-4">
                        Tire suas dúvidas em tempo real e receba orientações personalizadas para acelerar seu aprendizado.
                      </p>
                ...
                <Link href="/comunidade">
                  ...
                  >
                    <div className="relative z-10">
                      ...
                      <p className="text-sm text-slate-600 leading-relaxed mb-4">
                        Conecte-se com outros alunos, compartilhe suas experiências e troque ideias valiosas para crescerem juntos.
                      </p>
