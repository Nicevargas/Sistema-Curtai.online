    ...
    return (
      <main className="min-h-screen bg-white relative pb-24">
        ...
        <div className="max-w-md mx-auto px-4 py-20 text-center">
          <p className="text-slate-600 italic">Curso não encontrado.</p>
        </div>
        <BottomNav />
      </main>
    );
  ...
  return (
    <main className="min-h-screen bg-white relative pb-24">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 max-w-md mx-auto">
          ...
          >
            <span className="px-3 py-1 rounded-full bg-primary/80 text-[10px] font-bold uppercase tracking-widest text-white backdrop-blur-md">
              {journey.archetype === 'Jornada' ? 'Curso' : journey.archetype}
            </span>
            <h1 className="text-3xl font-bold text-slate-900 font-display leading-tight">{journey.title}</h1>
      ...
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        {journey.description && (
          <div className="mb-10">
            <h2 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">Sobre este Curso</h2>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xs font-bold text-slate-500 uppercase tracking-widest">Conteúdo do Curso</h2>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col justify-center flex-1 min-w-0">
                    ...
                    <h3 className={`text-sm font-bold line-clamp-1 mb-1 ${
                      completedLessons.has(lesson.id) ? 'text-slate-500' : 'text-slate-900'
                    }`}>{lesson.titulo}</h3>
        ...
        {lessons.length === 0 && (
          <div className="py-12 text-center rounded-3xl bg-slate-50 border border-dashed border-slate-200">
            <Sparkles className="size-10 text-slate-400 mx-auto mb-3" />
            <p className="text-slate-600 text-sm italic">Em breve, novas aulas para este curso.</p>
          </div>
        )}
      </div>
